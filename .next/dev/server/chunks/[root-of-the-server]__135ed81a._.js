...
async function POST(req) {
    ...
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].supplier.findUnique({
        where: {
            name: body.name
        }
    });
    ...
    const supplier = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].supplier.create({
        data: {
            name: body.name,
            email: body.email,
            phone: body.phone,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__135ed81a._.js.map