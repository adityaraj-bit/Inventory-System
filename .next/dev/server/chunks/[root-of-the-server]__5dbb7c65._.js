...
;
async function logAction({ userId, action, entity, entityId, metadata, ipAddress }) {
    try {
...
async function GET() {
    ...
    const customers = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.findMany({
        include: {
            _count: {
                select: {
                    salesOrders: true
...
async function POST(req) {
    const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authGuard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])();
    ...
    if (body.email) {
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.findFirst({
            where: {
                email: body.email
            }
        });
    ...
    const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.create({
        data: {
            name: body.name,
            email: body.email,
            phone: body.phone,
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$audit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAction"])({
        userId: auth.userId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5dbb7c65._.js.map