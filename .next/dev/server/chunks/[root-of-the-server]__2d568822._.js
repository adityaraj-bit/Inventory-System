...
async function GET(req) {
    ...
    const [products, customers, suppliers, orders] = await Promise.all([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.findMany({
            where: {
                OR: [
                    {
                        name: {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].supplier.findMany({
            where: {
                name: {
                    contains: search,
                    mode: "insensitive"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d568822._.js.map