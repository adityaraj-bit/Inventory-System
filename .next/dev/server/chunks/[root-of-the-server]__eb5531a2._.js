...
async function POST(req) {
    ...
    for (const item of body.items){
        if (item.quantity <= 0 || item.price < 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Item quantity must be greater than 0 and price must be non-negative"
            }, {
                status: 400
            });
        }
    ...
    if (!totalAmount) {
        totalAmount = body.items.reduce((acc, item)=>acc + item.price * item.quantity, 0);
    }
    try {
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
            // Create the order
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb5531a2._.js.map