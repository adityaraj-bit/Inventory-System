...
async function POST(req) {
    ...
    // check duplicate SKU
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findUnique({
        where: {
            sku: body.sku
        }
    });
    ...
    // validate category
    const category = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.findUnique({
        where: {
            id: body.categoryId
        }
    });
    ...
    if (body.supplierId) {
        const supplier = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].supplier.findUnique({
            where: {
                id: body.supplierId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8d1bae71._.js.map