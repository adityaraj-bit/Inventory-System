...
async function GET() {
    ...
    const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.findMany({
        where: {
            isActive: true
        },
        orderBy: {
...
async function POST(req) {
    ...
    // check duplicate
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.findUnique({
        where: {
            name: body.name
        }
    });
    ...
    const category = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].category.create({
        data: {
            name: body.name
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a4d109a._.js.map