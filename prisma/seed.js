const { PrismaClient, Role, OrderType } = require("@prisma/client");
const bcrypt = require("bcryptjs");

const prisma = new PrismaClient();

async function main() {
  console.log("🌱 Seeding Simplified Inventory Data...");
  ...
  console.log("✅ Seed Data successfully updated and applied!");
}
